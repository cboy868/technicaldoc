...
function searchbar_listener(event) {
    ...
    if (q !== '') {
      var url = 'https://github.com/cboy868/technicaldoc/search?utf8=✓&q=' + encodeURIComponent(q);
